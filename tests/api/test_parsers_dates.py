...
class ParserDateCase(unittest.TestCase):
     ...
     def test_from_abosulte_date_Days(self):
        ...
        adate_miliseconds= datetime.strptime(str(now.date()),'%Y-%m-%d').timestamp()*1000
     ...
     def test_from_endday_date(self):
        ...
        adate_miliseconds= (datetime.strptime(str(now.date()),'%Y-%m-%d')+ timedelta(hours=23,minutes=59,seconds=59)).timestamp()*1000
        self.assertEqual(response_miliseconds,adate_miliseconds)
     ...
     # FromDate in miliseconds (1663664778239) corresponds to "Tue Sep 20 2022 11:06:18"
     # FromDate in miliseconds Abosulte (1663624800000) corresponds to "Tue Sep 20 2022 00:00:00"
     ...
     def test_to_Date_absolute_Days(self):
        fromDateMiliseconds = 1663664778239.2002
        fromDateMilisecondsAbosulte = 1663624800000
     ...
     def test_to_Date_endday(self):
        fromDateMiliseconds = 1663664778239.2002
        response = 1663711199000 #Corresponds to Tue Sep 20 2022 23:59:59
     ...
     def test_to_Date_endmonth(self):
        fromDateMiliseconds = 1663664778239.2002
        response = 1664575199000 #Corresponds to Fri Sep 30 2022 23:59:59
