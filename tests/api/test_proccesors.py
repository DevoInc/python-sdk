...
class TestApi(unittest.TestCase):
    ...
    def test_proc_json_simple(self):
        ...
        self.assertEqual(processors.proc_json_simple()(self.stream_spaces), None)
        self.assertEqual(processors.proc_json_simple()(self.valid_json)["b"], 2)
    ...
    def test_proc_json_compact_simple_to_jobj(self):
        self.assertEqual(
            processors.proc_json_compact_simple_to_jobj(self.names)(self.stream_spaces),
            {},
        )
        self.assertEqual(
